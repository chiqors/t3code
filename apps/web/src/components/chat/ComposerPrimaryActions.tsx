...
import { ChevronDownIcon, ChevronLeftIcon, ListPlusIcon, SendIcon } from "lucide-react";
      ...
      <div className="flex items-center gap-1.5">
        {hasSendableContent ? (
          <Button
            ...
            variant="outline"
            className={cn("rounded-full", compact ? "size-8" : "px-3")}
            {...pointerFocusProps}
            aria-label={queueEnabled ? "Queue message" : "Steer message"}
          >
            {queueEnabled ? (
            ...
            {!compact ? (queueEnabled ? "Queue" : "Steer") : null}
          </Button>
        ) : null}
        <button
          type="button"
