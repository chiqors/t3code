...
export const GET_WINDOW_ZOOM_FACTOR_CHANNEL = "desktop:get-window-zoom-factor";
export const WINDOW_ZOOM_FACTOR_CHANGED_CHANNEL = "desktop:window-zoom-factor-changed";
